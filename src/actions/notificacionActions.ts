import API from "../api/Notificacion";
import snackBarUpdate from "../actions/snackBarActions";
import { updateModal } from "../actions/modalActions";
import { ACTIONS } from '../interfaces/actionTypes/notificacionTypes';
...
export const create = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200 || status === 201) {
      ...
      snackBarUpdate({
        payload: {
          message: "Notificacion ha sido Registrado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const update = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Notificacion ha sido Actualizado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const remove = (id: number) => async (dispatch: Function) => {
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Notificacion ha sido Elmiminado!",
          type: "success",
          status: true
        }
      })(dispatch);
